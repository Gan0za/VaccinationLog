...
@Database(entities = [UsersEntitie::class, VaccinesEntitie::class, HistoryEntitie::class], version = 3, exportSchema = true)
            ...
            synchronized(this) {
                ...
                if (instance == null) {
                    instance = Room.databaseBuilder(context.applicationContext,
                        VaccinationDatabase::class.java, "vaccination_log_db3")
                        .build()
                    INSTANCE = instance
                }
                return instance
